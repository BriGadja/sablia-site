...
|---|---|---|
| `plans/sablia-site-ux-migration.md` | **Phases 1+2+3+4/7 DONE 2026-04-20** — Phase 4 : Landing.tsx réécrit en ordre canonique (Nav → Hero → Friction → Offers → Authority → WhatReveals → Method → Proof → CalculatorROI → DiagnosticForm#anchor → Faq → FinalCta → Footer). MethodSection promu eager, DiagnosticForm replacé entre CalculatorROI et Faq, 2 Suspense boundaries autour des chunks lazy (Proof+Calc / Faq+FinalCta). App.tsx inchangé, consent→initGA4 wiring intact, WEBHOOK_DIAGNOSTIC câblé. 27/27 tests verts, tsc clean, build 6.94s. Smoke test live browser/webhook déféré à Phase 6. Next : Phase 5 pages secondaires (tokens propagation /tarifs /about /faq /cas-clients /roi /legales) + docs update. Deadline dure 2026-05-01. | `/execute sablia-site-ux-migration -- Phase 5 pages secondaires + docs` |
