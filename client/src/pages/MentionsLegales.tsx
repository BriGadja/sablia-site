    ...
    >
      ...
      <main className="container mx-auto px-4 py-16">
        ...
        <div className="max-w-4xl mx-auto prose prose-invert prose-lg">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-white">Responsable de la publication</h2>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-300">
              L'utilisation du site sablia.io implique l'acceptation des présentes mentions légales. En cas de non-respect, l'accès au site peut être suspendu ou interdit.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-white">Protection des données personnelles</h2>
            <p className="text-gray-300">
              Les données collectées via le site sont destinées à l'usage exclusif de GACHADOAT Brice. Conformément au Règlement Général sur la Protection des Données (RGPD), vous disposez d'un droit d'accès, de rectification ou de suppression de vos données personnelles. Pour exercer ces droits, contactez-nous à l'adresse : <a href="mailto:brice@sablia.io" className="text-orange-500 hover:text-orange-400">brice@sablia.io</a>
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-300">
              Le site sablia.io peut contenir des liens vers d'autres sites. GACHADOAT Brice n'est pas responsable du contenu ou des pratiques de ces sites.
            </p>
          </section>
        </div>
      </main>
