          ...
          <main className="container mx-auto px-4 py-16">
            ...
            <div className="max-w-4xl mx-auto prose prose-lg">
              ...
              <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold mb-3 text-sablia-text">1.1 Objet</h3>
              ...
              <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold mb-3 text-sablia-text">2.2 Devis</h3>
              ...
              {/* Article 3 */}
              <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-4 text-sablia-text">ARTICLE 3 - TARIFS</h2>

                <h3 className="text-xl font-semibold mb-3 text-sablia-text">3.1 Prix</h3>
                <p className="text-sablia-text-secondary mb-4">
                ...
                <p className="text-sablia-text-secondary mb-2">Les tarifs en vigueur sont :</p>
                <ul className="text-sablia-text-secondary list-disc ml-6 space-y-1 mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 text-sablia-text">3.3 Frais annexes</h3>
                <p className="text-sablia-text-secondary">
              ...
              <section className="mb-8">
                ...
                <p className="text-sablia-text-secondary font-semibold mb-2">C) Premier mois</p>
                <p className="text-sablia-text-secondary mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 text-sablia-text">4.6 Garanties</h3>
                <p className="text-sablia-text-secondary">
              ...
              <section className="mb-8 p-6 bg-gray-50 rounded-lg">
                <p className="text-sablia-text-secondary mb-4">
                  <strong className="text-sablia-text">
                ...
                <p className="text-sablia-text-tertiary mt-4 italic text-sm">
