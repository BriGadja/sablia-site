      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">
            Estimez rapidement les économies réalisées grâce à l'automatisation de vos tâches
            répétitives
          </p>
        </motion.div>
                ...
                <div className="mb-8">
                  ...
                  >
                    <div className="flex items-center justify-center space-x-2 bg-gray-700/50 rounded-lg px-4 py-2 cursor-pointer hover:bg-gray-700 transition">
                      ...
                      <Label htmlFor="daily" className="text-gray-200 cursor-pointer">
                        Quotidienne
                      </Label>
                    </div>
                    ...
                    <div className="flex items-center justify-center space-x-2 bg-gray-700/50 rounded-lg px-4 py-2 cursor-pointer hover:bg-gray-700 transition">
                      ...
                      <Label htmlFor="weekly" className="text-gray-200 cursor-pointer">
                        Hebdomadaire
                      </Label>
                    </div>
                      ...
                      <div className="space-y-2 mb-4">
                        <div className="flex justify-between">
                          ...
                          <span className="text-blue-400 font-bold">
                            {formatHours(results.hoursYearly)}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-400">Économies financières:</span>
                          <span className="text-green-400 font-bold">
                            {formatCurrency(results.savingsYearly)}
                          </span>
                        </div>
                      </div>
                    </CardContent>
                      ...
                      <div className="space-y-2 mb-4">
                        <div className="flex justify-between">
                          ...
                          <span className="text-purple-400 font-bold">
                            {formatHours(results.hoursMonthly)}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-400">Économies financières:</span>
                          <span className="text-green-400 font-bold">
                            {formatCurrency(results.savingsMonthly)}
                          </span>
                        </div>
                      </div>
                    </CardContent>
                  ...
                  <div className="p-6 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                      ...
                      <div className="bg-gray-800/50 rounded-xl p-4 border border-gray-700">
                        ...
                        <p
                          className={`text-2xl font-bold ${getRoiColorClass(results.roiPercentage)}`}
                        >
                            ...
                            <Tooltip>
                              ...
                              <TooltipContent className="bg-gray-900 text-gray-200 border-gray-700">
                                <p className="max-w-xs">
                                  Temps nécessaire pour que les économies dépassent l'investissement
                                </p>
                              </TooltipContent>
                            </Tooltip>
                          </TooltipProvider>
                          ...
                          <TooltipProvider>
                            <Tooltip>
                              ...
                              <TooltipContent className="max-w-xs bg-gray-900 text-gray-200 border-gray-700">
                                <p>
                                  Date à laquelle votre investissement sera rentabilisé (inclut 20
