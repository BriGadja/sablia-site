...
const DashboardSvg = () => (
  ...
  >
    ...
    <polyline
      points="40,200 80,180 120,190 160,150 200,120 240,100 280,90"
      stroke="#8B5CF6"
      strokeWidth="3"
      strokeLinecap="round"
    />
    <polyline
      points="40,200 80,160 120,170 160,140 200,130 240,120 280,110"
      stroke="#10B981"
      strokeWidth="3"
      strokeLinecap="round"
    />
...
export default function RoiBanner() {
  return (
    <section
      id="roi-banner"
      className="py-16 bg-gradient-to-r from-gray-100 to-gray-200 relative overflow-hidden"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-lg sm:text-xl text-gray-600 mb-8 leading-relaxed">
              Découvrez instantanément combien vos automatisations vont vous rapporter chaque mois
              et à quelle date vous atteignez le seuil de rentabilité.
            </p>
            ...
            <div className="flex flex-col items-center md:items-start space-y-4">
              ...
              <p className="text-sm text-gray-500">
                Aucune donnée sensible requise – résultat immédiat
              </p>
            </div>
          </div>
    ...
    <section className="py-12 bg-gray-800 text-center">
      <div className="container mx-auto px-4">
        ...
        <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
          Utilisez notre calculateur intuitif et découvrez en quelques clics la rentabilité de vos
