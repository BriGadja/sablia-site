...
const services = [
  {
    ...
    benefits: ["Gain de temps jusqu'à 70%", "Zéro erreur humaine", "Suivi en temps réel"],
  ...
  },
  {
    ...
    description:
      "Des assistants intelligents qui automatisent vos tâches et améliorent votre productivité.",
    benefits: ["Disponible 24/7", "Traitement automatique", "Gain de productivité"],
