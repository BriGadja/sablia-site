...
export const WEBHOOK_CONTACT =
  import.meta.env.VITE_CONTACT_WEBHOOK_URL || 'https://n8n.sablia.io/webhook/sablia-site-formulaire'

export const WEBHOOK_GAP =
  import.meta.env.VITE_GAP_WEBHOOK_URL || 'https://n8n.sablia.io/webhook/sablia-site-gap'

export const WEBHOOK_DIAGNOSTIC =
  import.meta.env.VITE_DIAGNOSTIC_WEBHOOK_URL ||
  'https://n8n.sablia.io/webhook/sablia-site-diagnostic'
